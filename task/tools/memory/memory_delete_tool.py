...
class DeleteMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        ...
        return ("Permanently deletes ALL long-term memories stored about the user. "
                "Use this ONLY when the user explicitly asks to forget everything, clear their memory, or reset "
                "what is remembered about them. This action cannot be undone and removes every stored memory, "
                "not a specific one - do not use it to remove a single fact.")
