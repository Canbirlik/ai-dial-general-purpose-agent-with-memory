...
class StoreMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        ...
        return ("Stores a long-term memory about the user for future conversations. "
                "Use this whenever the user shares an important, novel fact about themselves that would be useful "
                "to remember later, such as preferences, personal info, goals/plans, or other lasting context. "
                "Do NOT use it for trivial, one-off, or already-known facts, or for information that is only "
